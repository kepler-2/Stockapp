...
public class EditLeagueAdapter extends BaseAdapter {

    private Activity activity;
    private LayoutInflater inflater;
    private List<EditLeaguesBean> DataList;
    private List<Boolean> isBtnAdd;
    private TextView txt_playersName;
    private ImageView img_addplayer,img_removepalyer;
    private CardView card_view;
    private EditLeaguesBean allStockModel;
    private ProgressDialog mProgressDialog;
    private String ADD_MYPLID;
    //private int accessPosition;


    public EditLeagueAdapter(Activity activity, List<EditLeaguesBean> dataitem) {
    ...
    /*if(!afterEdit_MTID.toString().equalsIgnoreCase("")) {
       ...
       /* if(position == AddMoreLeauge.mSelectedItem)
        ...
        final String clickItemName = allStockModel.getPlayerName();
        final String clickItemToken = allStockModel.getBY_TYPE();
        final String clickItemsmid = allStockModel.getPLID();


        txt_playersName.setText(allStockModel.getPlayerName());
